  ...
  <div>
    <el-form :model="loginForm" label-width="80px" class="loginForm" :rules="rules" @keyup.enter.native="submitLogin()">
      ...
      <el-form-item label="密码:" prop="password">
        <el-input :type="(eyepassword ? 'text' : 'password')" v-model="loginForm.password" placeholder="请输入密码"
      ...
      <el-form-item label="验证码:" prop="code">
        <el-input placeholder="请填写验证码" class="inputText" v-model="loginForm.code" prefix-icon="el-icon-key">
        </el-input>
